...
%     NETRA:config:missingKey    a required threshold key is absent.
    ...
    requiredKeys = { ...
        ...
        'quality.featureWeights', ...
        'quality.focusLaplacianMin', ...
        'quality.focusTenengradMin', ...
        'quality.saturatedFractionMax', ...
        'quality.darkFractionMax', ...
        'quality.contrastStdMin', ...
        'quality.localContrastMin', ...
        'quality.hardRejectFovCompleteness', ...
        'quality.useClassifier', ...
        'io.minDimension', ...
        'io.maxAspectRatio', ...
        'io.fundusPlausibilityMin', ...
        'io.supportedFormats', ...
        'preproc.claheClipDefault', ...
        'preproc.claheClipMax', ...
        'preproc.targetSize', ...
        'preproc.fovThresholdMethod', ...
        'preproc.fovFixedThreshold', ...
        'preproc.fovMinAreaFraction', ...
        'preproc.illumKernelFraction', ...
        'preproc.uniformityTrigger', ...
        'preproc.claheClipMin', ...
        'preproc.contrastTarget', ...
        'preproc.denoiseTrigger', ...
        'preproc.benGrahamSigmaFraction', ...
        'degradation.blurSigmaRange', ...
        'degradation.gammaRange', ...
        'degradation.hazeAlphaRange', ...
        'degradation.occlusionFractionRange', ...
        'lesions.maAreaMax', ...
        ...
        'lesions.seLength', ...
        'lesions.seOrientations', ...
        'lesions.redThresholdFactor', ...
        'lesions.heAreaMin', ...
        'lesions.exSharpnessMin', ...
        'lesions.maculaRadiusDiscDiameters', ...
        'lesions.referenceOdRadius512', ...
        'grading.modelInputSize', ...
        'grading.classOrder', ...
        'grading.referableThreshold', ...
        'grading.confidenceMin', ...
        'grading.confidenceHigh', ...
        'grading.confidenceLow', ...
        'grading.temperature', ...
        'grading.disagreementLevels', ...
        'grading.useFusion', ...
        'xai.gradcamPercentile', ...
        'xai.lesionDilationPx', ...
        'xai.alaLowThreshold', ...
        'xai.alaHighThreshold', ...
        'xai.gradcamColormap', ...
        'structures.discDiameterRatioFovea', ...
        'structures.frangiScales', ...
        'structures.vesselThreshold', ...
        'structures.minVesselLength', ...
        'structures.odSearchTopPercent', ...
        'structures.odRadiusRange', ...
        'structures.foveaDiscDiameters', ...
        'structures.foveaSearchWindow', ...
        'structures.odFallbackRadiusFraction'};
